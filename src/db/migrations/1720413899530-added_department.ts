...
export class AddedDepartment1720413899530 implements MigrationInterface {
    name = 'AddedDepartment1720413899530'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "address" ALTER COLUMN "line" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "address" DROP COLUMN "pincode"`);
        await queryRunner.query(`ALTER TABLE "address" ADD "pincode" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "address" ALTER COLUMN "line" SET NOT NULL`);
